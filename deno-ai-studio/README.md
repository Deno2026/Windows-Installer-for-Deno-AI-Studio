# [Deno AI Studio](https://raw.githubusercontent.com/Deno2026/Windows-Installer-for-Deno-AI-Studio/main/deno-ai-studio/updates/windows-x64/Deno%20AI%20Studio%20Setup%200.1.37.exe)
...
Current installer: **Deno AI Studio Setup 0.1.37.exe**

Latest update: model install detection now records each model's real install path and re-checks all known workspace locations on startup, so downloaded models are not missed after updates or custom install-path changes.
...
6. Download and run **Deno AI Studio Setup 0.1.37.exe**
...
[Download Deno AI Studio Setup 0.1.37.exe](https://raw.githubusercontent.com/Deno2026/Windows-Installer-for-Deno-AI-Studio/main/deno-ai-studio/updates/windows-x64/Deno%20AI%20Studio%20Setup%200.1.37.exe)

Then:

1. Run `Deno AI Studio Setup 0.1.37.exe`
